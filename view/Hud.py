...
class Hud:
    def __init__(self,game) -> None:
        ...
        self.special_dot_surface.fill((0,255,0,0))
        ...
        self.ability_ready = pygame.image.load("assets\\images\\sprites\\Dot_02.png")
        self.ability_ready = pygame.transform.scale(self.ability_ready, (25, 26))
        self.ability_ready_rect = self.ability_ready.get_rect(center=(self.special_dot_surface.get_width()/2, self.special_dot_surface.get_height()/2))
    ...
    def draw_hud(self):
        ...
        if self.bombe_available:
            self.ability_ready_rect = self.clock_icon_img.get_rect(center=(self.special_dot_surface.get_width()/2, self.special_dot_surface.get_height()/2))
            self.special_dot_surface.blit(self.ability_ready, self.ability_ready_rect)
        else:
            self.clock_icon_rect = self.clock_icon_img.get_rect(center=(self.special_dot_surface.get_width()/2, self.special_dot_surface.get_height()/2))
